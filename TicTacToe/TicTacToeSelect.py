...
class TicTacToeSelect(customtkinter.CTkFrame):
    def __init__(self, app):
        super().__init__(app.tk)
        self.app = app
        self.configure(fg_color="#0D1321")
        self.createTicTacToeSelect()

    def createTicTacToeSelect(self):
        TopLabelFrame = customtkinter.CTkLabel(self, text="Games Platform", fg_color="#1D2D44", text_color="#FFFFFF",font=("Roboto", 40, "bold"), height=100)
        ...
        vsComputerButton = customtkinter.CTkButton(self, text="vs Player", fg_color="#3E5C76", text_color="#FFFFFF",corner_radius=25, font=("Roboto", 20, "bold"), height=100, width=400,command=self.app.showTicTacToe)
        vsComputerButton.grid(row=1, column=0, pady=(10, 20), padx=20)

        vsAIButton = customtkinter.CTkButton(self, text="vs Computer", fg_color="#3E5C76", text_color="#FFFFFF",corner_radius=25, font=("Roboto", 20, "bold"), height=100, width=400,command=self.app.showTicTacToeAI)
